...
│   │   ├── superadmin-support.tsx  # Superadmin support ticket panel
...
│   │   ├── superadmin.tsx          # Superadmin layout (/superadmin) — auth guard
│   │   ├── superadmin.index.tsx    # Superadmin home (/superadmin/)
│   │   ├── superadmin.centres.tsx  # Centre management (/superadmin/centres)
│   │   ├── superadmin.admins.tsx   # Admin management (/superadmin/admins)
│   │   └── superadmin.demandes.tsx # Demo requests (/superadmin/demandes)
...
- Auth guards in `dashboard.tsx` and `superadmin.tsx` via `beforeLoad`
