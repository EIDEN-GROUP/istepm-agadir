...
type Payment = {
  ...
  receipt: string;
  invoiceSent: boolean;
  client?: { parentName: string; childName: string; phone: string } | null;
};
              ...
              {payments.map((p) => (
                <tr key={p.id} className="hover:bg-muted/40">
                  <td className="px-4 py-3 font-medium">
                    {p.client?.parentName ?? p.clientId}
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <span className={cn(statusPill, "uppercase text-[10px]")}>
                      {p.mode}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-muted-foreground">
