...
function DashboardIndex() {
  ...
  if (!stats)
    return (
      <div className="flex min-h-[50vh] items-center justify-center">
        <div className="h-8 w-8 animate-spin rounded-full border-4 border-[#28396C] border-t-transparent" />
      </div>
    );
  ...
  const cards = [
    ...
    {
      label: "Payé ce mois",
      value: `${stats.paidThisMonth.toLocaleString("fr-FR")} MAD`,
      color: "bg-[#B5E18B]",
    },
    {
      label: "Dette totale",
      value: `${stats.totalDebt.toLocaleString("fr-FR")} MAD`,
      color: "bg-[#E25C5C]",
    },
    {
      label: "Revenu total",
