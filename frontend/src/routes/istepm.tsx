 ...
 * le rôle est déduit du compte. Les étudiants ont leur propre portail (`/login`).
 */
function StaffLoginPage() {
  ...
  useEffect(() => {
    document.title = "Espace personnel | ISTEPM Agadir";
  }, []);
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1.5 text-sm text-muted-foreground">
            Connexion réservée au personnel de l&rsquo;ISTEPM Agadir
          </p>
        </div>
        ...
        <p className="mt-2 text-center text-[11px]">
          ...
          >
            Lien d&rsquo;invitation expiré ou non reçu ? Recevoir un nouveau lien
          </button>
        </p>
      </motion.div>
    </div>
...
export const Route = createFileRoute("/istepm")({
  beforeLoad: () => {
    if (getStoredRole()) {
